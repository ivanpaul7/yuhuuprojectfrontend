...
export class MockInternshipDetailsService {
  public getInternship(internshipID: string): Internship {
    return new Internship(
      ...
      'aliqua. Egestas integer eget aliquet nibh. Ullamcorper dignissim ' +
      'cras tincidunt lobortis feugiat vivamus. Imperdiet sed euismod ' +
      'nisi porta. Congue quisque egestas diam in arcu cursus euismod. ' +
